...
- You can combine [[CleanCode/Builder]] with [[CleanCode/Bridge]]: the director class plays the role of the abstraction, while different builders act as implementations.